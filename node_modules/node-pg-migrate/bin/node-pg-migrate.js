  ...
  "bin/node-pg-migrate.ts"() {
    ...
    function readTsconfig() {
      if (tsconfigPath) {
        ...
        try {
          const config2 = _nodefs.readFileSync.call(void 0, _nodepath.resolve.call(void 0, process.cwd(), tsconfigPath), {
            encoding: "utf-8"
          });
          ...
          if (tsconfig["ts-node"]) {
            tsconfig = {
              ...
              ...tsconfig["ts-node"],
              compilerOptions: {
                ..._nullishCoalesce(tsconfig.compilerOptions, () => ( {})),
                ..._nullishCoalesce(tsconfig["ts-node"].compilerOptions, () => ( {}))
              }
            };
          }
        } catch (err) {
    ...
    if (configFileName) {
      const jsonConfig = require(_nodepath.resolve.call(void 0, configFileName));
      readJson(jsonConfig);
    }
    readTsconfig();
    ...
    if (action === "create") {
      ...
      _dist.Migration.create(newMigrationName, MIGRATIONS_DIR, {
        ...
        console.log(_nodeutil.format.call(void 0, "Created migration -- %s", migrationPath));
        process.exit(0);
      }).catch((err) => {
        console.error(err);
        process.exit(1);
      ...
      if (!DB_CONNECTION) {
        const cp = new (0, _connectionparameters2.default)();
      ...
      const promise = action === "redo" ? _dist2.default.call(void 0, options("down")).then(
        () => _dist2.default.call(void 0, options("up", Infinity, false))
      ) : _dist2.default.call(void 0, options(action));
      promise.then(() => {
...
exports. default = require_node_pg_migrate();
