"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _dropOperator = require('./dropOperator');
function createOperator(mOptions) {
  ...
  _create.reverse = _dropOperator.dropOperator.call(void 0, mOptions);
  return _create;
}
