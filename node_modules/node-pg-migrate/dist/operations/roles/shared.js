...
function formatRoleOptions(roleOptions = {}) {
  ...
  if (roleOptions.password !== void 0) {
    ...
    options.push(`${encrypted} PASSWORD ${_utils.escapeValue.call(void 0, roleOptions.password)}`);
  }
  if (roleOptions.valid !== void 0) {
    const valid = roleOptions.valid ? _utils.escapeValue.call(void 0, roleOptions.valid) : "'infinity'";
...
exports.formatRoleOptions = formatRoleOptions;
