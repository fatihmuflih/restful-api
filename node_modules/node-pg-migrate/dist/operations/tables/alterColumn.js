...
function alterColumn(mOptions) {
  return (tableName, columnName, options) => {
    ...
    if (defaultValue === null) {
      ...
      actions.push(`SET DEFAULT ${_utils.escapeValue.call(void 0, defaultValue)}`);
    }
    if (type) {
      const typeStr = _utils.applyTypeAdapters.call(void 0, type);
