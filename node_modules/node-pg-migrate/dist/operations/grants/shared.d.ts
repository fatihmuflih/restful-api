...
export declare type TablePrivilege = 'SELECT' | 'INSERT' | 'UPDATE' | 'DELETE' | 'TRUNCATE' | 'REFERENCES' | 'TRIGGER';
export declare type SchemaPrivilege = 'CREATE' | 'USAGE';
export interface CommonOnTablesOptions {
    privileges: TablePrivilege | TablePrivilege[] | 'ALL';
    roles: Name | Name[];
}
export declare type CommonGrantOnTablesOptions = CommonOnTablesOptions & WithGrantOption;
...
export declare type RevokeOnObjectsOptions = OnlyGrantOption & CascadeOption;
